...
ukb_gwas <-
GWASs_list %>% 
  filter(str_detect(title, "A generalized linear mixed model association tool for biobank-scale data|Computationally efficient whole-genome regression for quantitative and binary traits")) %>% 
...
```{r SAVE data}
write.table(ukb_gwas, file = "data/gwas/ukb_gwas_selection_new.tsv", sep = "\t", row.names = TRUE, quote = FALSE)
```
